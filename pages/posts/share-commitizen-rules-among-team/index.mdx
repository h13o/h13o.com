...
export const meta = {
  title: "Share Commitizen Rules Among Team",
  description: 'Keep your teams commit consistent.',
  date: '2021-02-22',
  readTime: 3 
}
...
Sometimes, you'll find your commit messages are only `update` and `fix`, but difficult to understand git logs later. Working as a team, this is more stressful issues.

[Commitizen](https://github.com/commitizen/cz-cli) helps you to write git commits with **consistent rules**.

In this post, I'll tell you how to share commitizen settings among your teams.
